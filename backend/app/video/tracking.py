"""SmoothedCameraman and SpeakerTracker: the heart of stabilized vertical reframing.

SmoothedCameraman implements the "Heavy Tripod" pan logic — only moves when the
subject leaves the safe zone, slow (3 px/frame) when nearby, fast (15 px/frame)
when the distance is huge. SpeakerTracker prevents rapid speaker switching via
hysteresis (3x score bonus for the active speaker) and a frame-based cooldown.
"""
